-- Final Lead Notes Migration - Simple and Clean
-- Run this in Supabase SQL Editor

-- First, drop everything if it exists (cleanup)
...
-- Create simplified policies that will work
...
DO $$ 
BEGIN 
  RAISE NOTICE 'Lead notes table created successfully with simplified structure!';
END $$;